<?php
$section_early_booking = get_field('section_early_booking') ?: [];

$title = $section_early_booking['title'] ?? '';
$description = $section_early_booking['description'] ?? '';
$background_image = $section_early_booking['background_image'] ?? null;
$background_image_mobile = $section_early_booking['background_image_mobile'] ?? null;
$features = $section_early_booking['features'] ?? [];
?>

<section class="preorder-section">
    <div class="preorder-bg-wrapper">
        <div class="preorder-overlay-top"></div>
        <div class="preorder-overlay-bottom"></div>
        <?php echo wp_get_attachment_image($background_image, 'full', false, array('class' => 'preorder-bg-img')); ?>
        <?php echo wp_get_attachment_image($background_image_mobile, 'full', false, array('class' => 'preorder-bg-img mobile')); ?>
    </div>

    <div class="preorder-container">
        <div class="preorder-content">
            <div class="preorder-header">
                <h3 class="preorder-cursive"><?= esc_html($title); ?></h3>
                <h2 class="preorder-title"><?= esc_html($description); ?></h2>
            </div>

            <ul class="preorder-features">
                    ...
                    <li>
                        <span class="feature-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" viewBox="0 0 14 11" fill="none">
                                <path d="M0.561523 6.00073L3.80511 9.24432L12.4879 0.561523" stroke="#064F0F"
